    ...
    <div className="mt-16 px-4">
      ...
      <div className="mt-8">
        <div className="flex flex-col items-center">
          ...
          <div className="mt-8 grid w-full grid-cols-2 gap-8 border-b-2">
            <button
              className={cls(
      ...
      <form className="mt-8 flex flex-col">
        ...
        <button className="text-small mt-6 rounded-md border border-transparent bg-orange-500 py-2 px-4 font-medium text-white shadow-sm hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
