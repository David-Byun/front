...
export default function Enter() {
  ...
  return (
    <div className="mt-16 px-4">
      <h3 className="mt-8 text-center text-3xl font-medium">Enter to Carrot</h3>
      <div className="mt-16">
        <div className="flex flex-col items-center">
          <h5 className="mb-8 text-sm text-gray-400">Enter using:</h5>
          <div className="grid w-full grid-cols-2 border-b-2">
            <button
              className={cls(
                "pb-4 font-medium",
                method === "email"
                  ? "border-b-2 border-orange-400 pb-4 text-orange-400"
                  : ""
              )}
          ...
          <div className="mt-1">
            {method === "email" ? (
              <input
                id="input"
                type="email"
                className="w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-orange-500 focus:outline-none focus:ring-orange-400"
                required
              />
            ) : null}
            {method === "phone" ? (
              <div className="flex rounded-md shadow-sm">
                ...
                <input
                  id="input"
                  type="number"
                  className="w-full appearance-none rounded-l-none border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-orange-500 focus:outline-none focus:ring-orange-400"
                  required
                />
              </div>
            ) : null}
