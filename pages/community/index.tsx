...
const Community: NextPage = () => {
  return (
    <div className="space-y-8 py-16">
      ...
      <button className="fixed bottom-24 right-5 cursor-pointer cursor-pointer rounded-full bg-orange-400 p-4 text-white shadow-xl transition hover:bg-orange-600">
        <svg
          className="h-6 w-6"
          fill="none"
          stroke="currentColor"
