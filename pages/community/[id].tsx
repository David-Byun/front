...
const CommunityPostDetail: NextPage = () => {
  return (
    <Layout canGoBack>
      <div>
        <span className="my-3 ml-4 inline-flex items-center rounded-full bg-gray-100 py-0.5 px-2.5 text-xs font-medium text-gray-800">
          동네질문
        </span>
        ...
        <div className="mt-2 px-2.5 text-gray-700">
          <span className="font-medium text-orange-500">Q.</span> What is the
          best restaurant?
        </div>
        <div className="mt-3 flex w-full space-x-5 border-t border-b-[1.5px] px-3 py-2.5 text-gray-700">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-700">
                The best mandu restaurant is the one to the next my house
              </p>
            </div>
          </div>
        </div>
