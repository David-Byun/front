...
const CommunityPostDetail: NextPage = () => {
  return (
    <div>
      <div>
        <span className="my-3 inline-flex items-center rounded-full bg-gray-100 py-0.5 px-4 text-xs font-medium text-gray-800">
          동네질문
        </span>
      </div>
      <div className="mb-3 flex cursor-pointer items-center space-x-3 border-t border-b px-4 py-3">
